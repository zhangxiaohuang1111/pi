...
os.putenv('SDL_MOUSEDRV', 'TSLIB')  # Use TSLIB for touchscreen
os.putenv('SDL_MOUSEDEV', '/dev/input/touchscreen')  # Set to symbolic link
    ...
    while running:
        ...
        for event in pygame.event.get():
            if event.type == MOUSEBUTTONDOWN:
                ...
                reset_timer()  # Reset the timeout when the screen is touched

...
# Define buttons
start_button_rect = pygame.Rect(60 - 60, height - 50, 120, 40)  # Start button
quit_button_rect = pygame.Rect(width - 120, height - 50, 120, 40)  # Quit button
...
# Initialize flags
animation_running = False  # Start animation only when Start button is pressed
...
def draw_buttons():
    ...
    # Quit button
    pygame.draw.rect(screen, (255, 255, 255), quit_button_rect, 2)
    quit_text = font_big.render('Quit', True, (255, 255, 255))
...
while True:
    ...
    if animation_running:
        ...
        # Redraw buttons on top of the animation
        draw_buttons()

...
pygame.mouse.set_visible(True)  # 设置为True以显示鼠标
font_small = pygame.font.Font(None, 17)

# GPIO Pin Setup for Buttons
buttonA_control = 17  # Button to control left motor
buttonA_stop = 22     # Button to stop left motor
buttonB_control = 23  # Button to control right motor
...
# Display function with STOP and QUIT interactions
def update_display():
    try:
        while running:
            screen.fill(BLACK)

    ...
    try:
        while running:
            ...
            if stop_resume_state == 'STOP':
                pygame.draw.circle(screen,RED, (80, 120), 30)  # Draw STOP button
                stop_resume_text = font_small.render("STOP", True, WHITE)
                screen.blit(stop_resume_text, (65, 115))
            else:  # If the state is 'RESUME'
                pygame.draw.circle(screen, GREEN, (80, 120), 30)  # Draw RESUME button
                stop_resume_text = font_small.render("RESUME", True, WHITE)
                screen.blit(stop_resume_text, (55, 115))
            ...
            for event in pygame.event.get():
                if event.type == MOUSEBUTTONDOWN:
                    ...
                    if 50 <= x <= 110 and 90 <= y <= 150:  # STOP/RESUME button position and size
                        if stop_resume_state == 'STOP':

...
faster_button_rect = pygame.Rect(110, 200, 80, 30)  # Faster button, moved to the right of Pause button
slower_button_rect = pygame.Rect(200, 200, 80, 30)  # Slower button, moved to the right of Faster button
back_button_rect = pygame.Rect(290, 200, 80, 30)    # Back button, moved to the right of Slower button

...
pause_button_rect = pygame.Rect(10, 200, 70, 30)    # Pause button
faster_button_rect = pygame.Rect(90, 200, 70, 30)   # Faster button
slower_button_rect = pygame.Rect(170, 200, 70, 30)  # Slower button
back_button_rect = pygame.Rect(250, 200, 70, 30)    # Back button

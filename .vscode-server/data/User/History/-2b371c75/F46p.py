        ...
        for event in pygame.event.get():
            if event.type == MOUSEBUTTONDOWN:
                ...
                if pause_button_rect.collidepoint(x, y):
                    ...
                    # Increase speed by a factor and clamp the speeds
                    ...
                    # Decrease speed, ensuring it doesn't go below the minimum speed, and clamp the speeds
                    speed1 = clamp_speed([s / SPEED_MULTIPLIER for s in speed1], MIN_SPEED, MAX_SPEED)
                    speed2 = clamp_speed([s / SPEED_MULTIPLIER for s in speed2], MIN_SPEED, MAX_SPEED)
                    print(f"New speed1: {speed1}, New speed2: {speed2}")
...
def handle_ball_movement():
    ...
    # Clamp the speeds within the defined min/max limits
    speed1 = clamp_speed(speed1, MIN_SPEED, MAX_SPEED)
    speed2 = clamp_speed(speed2, MIN_SPEED, MAX_SPEED)

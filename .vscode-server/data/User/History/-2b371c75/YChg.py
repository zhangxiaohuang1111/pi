...
speed1 = [6, 10]
speed2 = [4, 5]
MAX_SPEED = 20  # Maximum allowed speed
MIN_SPEED = 1   # Minimum allowed speed
        ...
        for event in pygame.event.get():
            if event.type == MOUSEBUTTONDOWN:
                ...
                if pause_button_rect.collidepoint(x, y):
                    ...
                    # Increase speed by a factor
                    speed1 = [s * SPEED_MULTIPLIER for s in speed1]
                    speed2 = [s * SPEED_MULTIPLIER for s in speed2]
                    print(f"New speed1: {speed1}, New speed2: {speed2}")
                
                elif slower_button_rect.collidepoint(x, y):
                    print("Slower button pressed")
                    # Decrease speed, ensuring it doesn't go below the minimum speed
                    speed1 = [max(s / SPEED_MULTIPLIER, MIN_SPEED) for s in speed1]
                    speed2 = [max(s / SPEED_MULTIPLIER, MIN_SPEED) for s in speed2]
                    print(f"New speed1: {speed1}, New speed2: {speed2}")
